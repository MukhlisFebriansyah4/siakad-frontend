  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">      
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Form Role Permission</h3>
      ...
      <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">Form Role(Peran)</h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse">
              <i class="fa fa-minus"></i>
            </button>
          ...
          <div class="box-body">
            <div class="row">              
              <div class="col-md-6">
                <div class="form-grup">
                  <label>Nama Dosen/Mahasiswa</label>
                  <div class="input-group">
                    <div class="input-group-addon">
                      <i class="fa fa-building"></i>
                    </div>
              ...
              <div class="col-md-6">
                <div class="form-grup">
                  <label>Memiliki Peran Sebagai</label>
                  <select class="form-control select2 select2-hidden-accessible pull-right" style="width:100%;" tabindex="-1" aria-hidden="true" required="">
                    <option selected="selected" disabled="disabled">Pilih Peran</option>
                    <option>Web Master</option>
                    <option>Data Base Master</option>
                  </select>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-grup">
                  <label>Di perbaharui pada</label>
                  <div class="input-group">
                    <div class="input-group-addon">
                      <i class="fa fa-building"></i>
                    </div>
